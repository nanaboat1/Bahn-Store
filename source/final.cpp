...
void myStore_Frontend(){
 ...
 //This function serves as the customer place where the user is a customer which contains functions that a customer will use like selecting item and and buying more stuffs
 // and receipt printing and a whole lotta stuffs I will explore later . Now, I must focus on my Math Test. 
   //print receipt, buy stuffs call. stocker. customer rating. Authorizing . Bro , like joke see ya later have a nath test due soon. 
